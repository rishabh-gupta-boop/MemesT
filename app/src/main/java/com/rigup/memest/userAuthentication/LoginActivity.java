...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(firebaseAuth.getCurrentUser() != null) {
            finish();
            Toast.makeText(this, "Welcom Back"+firebaseAuth.getCurrentUser().getDisplayName(), Toast.LENGTH_SHORT).show();
            startActivity(new Intent(LoginActivity.this, com.rigup.memest.MainActivity.class));
        ...
        forgotPass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LoginActivity.this, com.rigup.memest.userAuthentication.PWresetActivity.class));
            }
        });
